    ...
    */
    ...
    #include<mpi.h>
    #define N 2500
    #define NUM_ROWS_A N //rows of input [A]
    #define NUM_COLUMNS_A N //columns of input [A]
    #define NUM_ROWS_B N //rows of input [B]
    #define NUM_COLUMNS_B N //columns of input [B]
